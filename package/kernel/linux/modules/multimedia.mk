...
define KernelPackage/video-coda
  ...
  FILES:= \
	$(LINUX_DIR)/drivers/media/platform/chips-media/coda-vpu.ko@lt6.12 \
	$(LINUX_DIR)/drivers/media/platform/chips-media/imx-vdoa.ko@lt6.12 \
	$(LINUX_DIR)/drivers/media/platform/chips-media/coda/coda-vpu.ko@ge6.12 \
	$(LINUX_DIR)/drivers/media/platform/chips-media/coda/imx-vdoa.ko@ge6.12 \
...
define KernelPackage/dvb-tuner-si2157
  ...
  DEPENDS:=kmod-dvb-core +kmod-media-controller
